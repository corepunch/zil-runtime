...
Stable functional failures should be handed to `@game-tester` for independent reproduction and regression authoring. Do not encode subjective ease, prose taste, or persona preference as a regression.
